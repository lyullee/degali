"""Verification-only common-phase-grid differences of ACTUAL field values.

Subtract local products before summing; do not use analytic EOS derivatives.
"""
...
def paired_moment_difference(projection,parameters,rates,step,*,order=8,angular_order=8,batch_size=8):
